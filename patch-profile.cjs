...
code = code.replace(
  /el\('profile-account-badge'\)\.innerHTML=has\n\s+\?'<span class="portal-badge-active"><i class="fas fa-circle-check"><\/i> Portal Active<\/span>'\n\s+:'<span class="portal-badge-none"><i class="fas fa-circle-minus"><\/i> No Portal Account<\/span>';/,
  `el('profile-account-badge').innerHTML=has
